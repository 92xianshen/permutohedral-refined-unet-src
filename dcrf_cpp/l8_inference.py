...
import numpy as np
from eigen.pydensecrf import PyDenseCRF
...
if __name__ == "__main__":
    ...
    dcrf = PyDenseCRF(H=height, W=width, n_classes=n_classes, d_bifeats=d_bifeats, d_spfeats=d_spfeats, theta_alpha=80., theta_beta=.0625, theta_gamma=3., bilateral_compat=10., spatial_compat=3., n_iterations=10)
    ...
    rfn = out_1d.reshape((height, width, n_classes))
